...
import 'dart_cec_bindings_generated.dart';
...
const String _libName = 'dart_cec';

/// The dynamic library in which the symbols for [DartCecBindings] can be found.
...
final DartCecBindings _bindings = DartCecBindings(_dylib);
